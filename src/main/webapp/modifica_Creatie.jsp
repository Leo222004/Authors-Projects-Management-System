...
<head>
    ...
    <style>
        ...
        /* Font usor mai mic pentru a incapea mai multe date */
...
<body>
    ...
    <nav class="navbar navbar-dark bg-primary mb-4">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1 ps-3">Modificare Creație</span>
    ...
    <div class="container-fluid px-4">
        <div class="card p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="text-primary">Selectați creația pentru modificare</h3>
                <a href="nou_Creatie.jsp" class="btn btn-success">
                    <strong>+</strong> Adaugă Creație Nouă
                </a>
            </div>

            <form action="m1_Creatie.jsp" method="post">
