    ...
    <div class="container" style="max-width: 600px;">
        ...
        %>
            <div class="card p-5 text-center border-warning">
                ...
                <div class="mt-4">
                    <a href="tabela_Autori.jsp" class="btn btn-primary">Înapoi la Tabel</a>
                </div>
            </div>
        <%
        } else {
            jb.connect();
            try {
                jb.stergeDateTabela(s, "autori", "idautor");
                jb.disconnect();
        %>
            <div class="card p-5 text-center border-success">
                ...
                <div class="d-grid gap-2 col-8 mx-auto mt-4">
                    <a href="tabela_Autori.jsp" class="btn btn-primary">Înapoi la Tabela Autori</a>
        ...
        %>
            <div class="card p-5 text-center border-danger">
                ...
                <div class="alert alert-warning text-start">
                    ...
                    Autorul pe care încercați să îl ștergeți este asociat cu un proiect în tabela <strong>Creație</strong>. 
                    Trebuie să ștergeți mai întâi acele asocieri.<br><br>
                    <em>Eroare tehnică: <%= e.getMessage() %></em>
                </div>
                
                <div class="mt-4">
                    <a href="tabela_Autori.jsp" class="btn btn-secondary">Înapoi la Tabel</a>
                </div>
            </div>
        <%
            }
